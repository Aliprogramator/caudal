...
def _apple(url: str) -> dict:
    ...
    canciones = _apple_del_bloque(r.text)
    if not canciones:
        canciones, titulo, autor = _apple_del_jsonld(r.text)
    else:
    ...
    def recorrer(o, prof=0):
        ...
        if isinstance(o, dict):
            if o.get("kind") == "song" or ("title" in o and "subtitleLinks" in o):
                ...
                if titulo and (titulo, artista) not in vistas and artista:
